...
namespace TotalProcessing\TPCARDS\Block\Info;
...
class Info extends \Magento\Payment\Block\Info
{
     ...
     * @var string
     */
    protected $_template = 'TotalProcessing_TPCARDS::info/info.phtml';
    ...
    protected function _prepareSpecificInformation($transport = null)
    {
        ...
        $fraudResult = $this->getInfo()->getAdditionalInformation('TPCARDS_FRAUDFILTER_RESULT');
        $chosenPayment = $this->getInfo()->getAdditionalInformation('TPCARDS_CHOSEN_PMT_REF');
